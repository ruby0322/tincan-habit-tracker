  ...
  public: {
    Tables: {
      ...
      post: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_creator_user_id_fkey"
            columns: ["creator_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      publish: {
        ...
        Relationships: [
          {
            foreignKeyName: "publish_habit_id_fkey"
            columns: ["habit_id"]
            isOneToOne: true
            referencedRelation: "habit"
            referencedColumns: ["habit_id"]
      ...
      react_to: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "react_to_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      record: {
        ...
        Relationships: [
          {
            foreignKeyName: "record_creator_user_id_fkey"
            columns: ["creator_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      test: {
        ...
        Relationships: [
          {
            foreignKeyName: "test_author_fkey"
            columns: ["author"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
